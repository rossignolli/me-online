...
const defaultMeta = {
  title: 'Vitor Rossignolli - Frontend Developer',
  siteName: 'Vitor Rossignolli - Frontend Developer',
  description:
   ...
   */
  image: 'https://avatars.githubusercontent.com/u/34142721?v=4',
};
